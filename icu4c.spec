...
%files
%defattr(-,root,root,-)
/usr/lib32/icu/73.1/Makefile.inc
/usr/lib32/icu/73.1/pkgdata.inc
/usr/lib32/icu/Makefile.inc
/usr/lib32/icu/current
/usr/lib32/icu/pkgdata.inc
/usr/lib64/icu/73.1/Makefile.inc
/usr/lib64/icu/73.1/pkgdata.inc
...
%files data
%defattr(-,root,root,-)
/usr/share/icu/73.1/LICENSE
/usr/share/icu/73.1/config/mh-linux
/usr/share/icu/73.1/install-sh
/usr/share/icu/73.1/mkinstalldirs
...
/usr/lib64/libicui18n.so.73.1
/usr/lib64/libicuio.so.73
/usr/lib64/libicuio.so.73.1
/usr/lib64/libicutest.so.73
/usr/lib64/libicutest.so.73.1
/usr/lib64/libicutu.so.73
/usr/lib64/libicutu.so.73.1
/usr/lib64/libicuuc.so.73
/usr/lib64/libicuuc.so.73.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libicudata.so.73
/usr/lib32/libicudata.so.73.1
/usr/lib32/libicui18n.so.73
/usr/lib32/libicui18n.so.73.1
/usr/lib32/libicuio.so.73
/usr/lib32/libicuio.so.73.1
/usr/lib32/libicutest.so.73
/usr/lib32/libicutest.so.73.1
/usr/lib32/libicutu.so.73
/usr/lib32/libicutu.so.73.1
/usr/lib32/libicuuc.so.73
/usr/lib32/libicuuc.so.73.1
